    ...
    isVisible && (
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-5">
          <div className="border border-blue-500 flex flex-col justify-evenly p-4 text-xl rounded-xl">
            <div className="text-sm">2022 - present</div>
            <div className="text-3xl text-blue-500">IIEST, Shibpur</div>
            <div className="text-xl">B.Tech in CST</div>
            <div className="text-sm">CGPA : 9.54</div>
          </div>
          <div className="border border-blue-500 p-4 text-xl rounded-xl">
            <div className="text-sm">2020 - 2022</div>
            <div className="text-3xl text-blue-500">
              Nano Junior College, Nallakunta
            </div>
            <div className="text-xl">Intermediate in MPC</div>
